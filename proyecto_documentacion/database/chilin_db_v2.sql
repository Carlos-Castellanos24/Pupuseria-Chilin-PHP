...
--
INSERT INTO cliente VALUES (NULL, 'Estefany Elizabeth', 'Ramírez Nuñez', '00000000-0', 64229837,'HolaClave', 1, 'usuario@chilin.com', 'Lourdes colón, la libertad', 'F', 'A');
...
DEFINER
INSERT INTO cliente
VALUES ('NULL', nombre_cliente, apellido_cliente, dui, telefono, pw, rol, correo, direccion, sexo,estado_cliente);
...
in sexo2 ENUM('M', 'F'),
in estado_cliente2 char(2)
)
NOT DETERMINISTIC CONTAINS SQL SQL SECURITY
DEFINER
UPDATE cliente SET nombre_cliente= nombre_cliente2, apellido_cliente= apellido_cliente2, dui= dui2, telefono= telefono2, rol= rol2, correo= correo2, direccion= direccion2, sexo= sexo2, estado_cliente= estado_cliente2 WHERE id_cliente= id_cliente2;
...
(in id_cliente int ,
 in id_pedido int,
 in tipo_comentario char(2),
 in asunto text,
 in comentario text,
 in fecha datetime,
 in estado_comentario char(2)
 )
...
in id_cliente2  int, 
in id_pedido2 int ,
in tipo_comentario2 char(2),
in asunto2 text,
in comentario2 text,
in fecha2 datetime,
in estado_comentario2 char(2)   
)
NOT DETERMINISTIC CONTAINS SQL SQL SECURITY
DEFINER
...
in tipo_factura char(2),
in estado_factura char(2)
)
NOT DETERMINISTIC CONTAINS SQL SQL SECURITY
DEFINER
...
in tipo_factura2 char(2),
in estado_factura2 char(2)
)
NOT DETERMINISTIC CONTAINS SQL SQL SECURITY
DEFINER
