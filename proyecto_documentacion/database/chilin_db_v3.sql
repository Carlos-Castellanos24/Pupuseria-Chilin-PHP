...
INSERT INTO mesa	      VALUES (NULL, 1, 1, 5, '2021-12-02', '0', '0', 'Comentrio generico', 'D');
...
DEFINER
UPDATE cliente SET apellido_cliente = apellido_cliente3, dui = dui3, correo = correo3, direccion = direccion3, sexo = sexo3 WHERE id_cliente = id_cliente3;
...
CALL login_cliente(64229837,'HolaClave');
...
call buscar_telefono_cliente('64229837');
